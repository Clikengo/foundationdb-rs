...
" >> ./bindings/bindingtester/known_testers.py
  ...
  python2 ./bindings/bindingtester/bindingtester.py --num-ops 10000 --api-version 610 --test-name directory --concurrency 1 rust --no-directory-snapshot-ops --compare
)
